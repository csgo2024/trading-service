...
public class OpenBuyExecutor : BaseExecutor
{
    public OpenBuyExecutor(ILogger<OpenBuyExecutor> logger,
    ...
    public override StrategyType StrategyType => StrategyType.OpenBuy;
